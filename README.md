# Longest-Substring-Without-Repeating-Characters-Java-Implementation
...
Example 4:  Input: s = "" Output: 0    Constraints:  0 &lt;= s.length &lt;= 5 * 104 s consists of English letters, digits, symbols and spaces.
